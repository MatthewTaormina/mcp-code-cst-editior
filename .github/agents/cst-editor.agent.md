...
name: "CST Editor"
tools:[execute/runNotebookCell, execute/executionSubagent, execute/getTerminalOutput, execute/killTerminal, execute/sendToTerminal, execute/createAndRunTask, execute/runInTerminal, search/changes, search/codebase, search/fileSearch, search/listDirectory, search/textSearch, search/usages, cst-mcp-server/create_file, cst-mcp-server/delete_file, cst-mcp-server/delete_lines, cst-mcp-server/edit_node, cst-mcp-server/get_line_tokens, cst-mcp-server/get_node, cst-mcp-server/get_tree_skeleton, cst-mcp-server/insert_lines, cst-mcp-server/list_tracked_files, cst-mcp-server/load_file, cst-mcp-server/query_file, cst-mcp-server/query_tool, cst-mcp-server/query_workspace, cst-mcp-server/save_file, cst-mcp-server/track_file, cst-mcp-server/untrack_file]
---
